...
import com.daop.sso.common.utils.SpringUtils;
...
public class JobInvokeUtil {
     ...
     */
    public static void invokeMethod(JobInfo jobInfo) throws Exception {
        String beanName = jobInfo.getJobClass();
        String methodName = getMethodName(jobInfo.getJobMethod());
        List<Object[]> methodParams = getMethodParams(jobInfo.getJobMethod());
        if (!validClassName(jobInfo.getJobClass())) {
